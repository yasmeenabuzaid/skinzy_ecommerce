...
export default function BrandProductsPage() {
  ...
  if (isLoading) {
    return <div className="text-center p-10 text-gray-500">جاري تحميل المنتجات...</div>;
  }

  if (error) {
    return <div className="text-center p-10 text-red-500">حدث خطأ أثناء تحميل المنتجات</div>;
  }
    ...
    <div className="text-gray-800">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between mb-6 bg-[#f9f9f9] p-4 rounded-md">
          <h1 className="text-xl font-bold">منتجات البراند</h1>
